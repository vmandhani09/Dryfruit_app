...
const CITIES_BY_STATE: Record<string, string[]> = {
  ...
  "Maharashtra": ["Mumbai", "Pune", "Nagpur", "Thane", "Nashik", "Aurangabad", "Solapur", "Kolhapur", "Amravati", "Navi Mumbai", "Sangli", "Malegaon", "Jalgaon", "Akola", "Latur", "Dhule", "Ahmednagar", "Chandrapur", "Parbhani", "Ichalkaranji", "Jalna", "Ambarnath", "Bhusawal", "Panvel", "Badlapur", "Beed", "Gondia", "Satara", "Barshi", "Yavatmal", "Achalpur", "Osmanabad", "Nandurbar", "Wardha", "Udgir", "Hinganghat", "Nanded", "Ratnagiri", "Sindhudurg", "Buldhana", "Washim", "Palghar", "Raigad", "Alibaug", "Kalyan", "Dombivli", "Ulhasnagar", "Mira-Bhayandar", "Vasai-Virar", "Bhiwandi", "Shirdi", "Lonavala", "Khandala", "Mahabaleshwar", "Matheran", "Igatpuri", "Karjat", "Khopoli", "Pen", "Roha", "Mahad", "Chiplun", "Sawantwadi", "Kudal", "Malvan", "Vengurla", "Devgad", "Rajapur", "Khed", "Dapoli", "Guhagar", "Harnai", "Shrivardhan", "Murud", "Alibag", "Uran", "Panvel", "Kharghar", "Vashi", "Nerul", "Belapur", "Airoli", "Koparkhairane", "Sanpada", "Ghansoli", "Taloja", "Kamothe", "Kalamboli", "Khandeshwar", "Mansarovar", "New Panvel", "Dronagiri"],
